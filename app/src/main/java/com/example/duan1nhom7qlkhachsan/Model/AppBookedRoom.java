...
public class AppBookedRoom {
    private Integer id;
    private String codeRoom,nameRoom,typeRoom,priceRoom,startDay,endDay,roomId;

    public AppBookedRoom() {
    }

    public AppBookedRoom(Integer id, String codeRoom, String nameRoom, String typeRoom, String priceRoom, String startDay, String endDay) {
